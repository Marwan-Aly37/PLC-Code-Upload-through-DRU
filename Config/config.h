...
#define MicroController Micro_V85XX
...
#define  RELEASE     1
#define  SAVING_DIRECT_INTERNAL
#define    CRC_INTEGRITY_ENABLE
/******************************************************************************/
...
#undef MTR_SINGLE_PH              /*!< Single phase meter type.*/
#define MTR_THREE_PH              /*!< Trhee phase meter type.*/
#undef RS485_ENABLE
#undef GPRS_FEATURE
...
#undef ENGLISH_SCREEN
#define  ARABIC_SCREEN
#ifdef ARABIC_SCREEN
...
//#define RFID_FEATURE            /*!< Enable using RFID system.*/  /* DRU: RFID not used */
#endif
#ifdef RFID_FEATURE
#undef CONTACT_CARD
#define CONTACT_CONTACTLESS
#undef RFID_DEBUG_MEASUR_SPEED
#undef RFIDTEST_READ_WRITE_TOOL
#define RFID_BUFFER_LEN 2000
...
#undef CTRL_DN_SW /*!< Enable down switch control.*/
