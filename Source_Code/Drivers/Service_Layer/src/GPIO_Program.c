...
void S_GpioEnableRfidBoard(void)
{
  ...
  //S_GpioInit_PIN(RFID_MODULE_ENABLE_PORT_WITH_KEYPAD,RFID_MODULE_ENABLE_PIN_WITH_KEYPAD,S_GPIO_Mode_FORBIDDEN);
  //S_GpioInit_PIN(RFID_MODULE_ENABLE_PORT_WITH_KEYPAD,RFID_MODULE_ENABLE_PIN_WITH_KEYPAD,S_GPIO_Mode_OUTPUT_CMOS);
  //S_GPIO_Set_Bits(RFID_MODULE_ENABLE_PORT_WITH_KEYPAD,RFID_MODULE_ENABLE_PIN_WITH_KEYPAD);
}
/////////////////////////////-_E_-///////////////////////////////////////
/////////////////////////////-_N_-///////////////////////////////////////
/////////////////////////////-_D_-///////////////////////////////////////
...
void S_GpioDisableRfidBoard(void)
{
  ...
  //S_GpioInit_PIN(RFID_MODULE_ENABLE_PORT_WITH_KEYPAD,RFID_MODULE_ENABLE_PIN_WITH_KEYPAD,S_GPIO_Mode_FORBIDDEN);
  //S_GpioInit_PIN(RFID_MODULE_ENABLE_PORT_WITH_KEYPAD,RFID_MODULE_ENABLE_PIN_WITH_KEYPAD,S_GPIO_Mode_OUTPUT_CMOS);
  //S_GPIO_Clear_Bits(RFID_MODULE_ENABLE_PORT_WITH_KEYPAD,RFID_MODULE_ENABLE_PIN_WITH_KEYPAD);
}
/////////////////////////////-_E_-///////////////////////////////////////
/////////////////////////////-_N_-///////////////////////////////////////
/////////////////////////////-_D_-///////////////////////////////////////
...
S_GpioInit_PIN(LCD_BACK_LIGHT_PORT, BACK_LIGHT_PIN , S_GPIO_Mode_OUTPUT_CMOS);
  ...
  *************************************************************/
  ...
  S_GpioInit_PIN (SW_PORT,M_SW_PIN ,S_GPIO_Mode_INPUT);
#else
  S_GpioInit_PIN(SW_PORT,M_SW_PIN, S_GPIO_Mode_FORBIDDEN);
  S_GPIO_Set_Bits(SW_PORT,M_SW_PIN);
#endif
#endif
...
/* cs*/
  ...
  S_GPIO_Clear_Bits(SOFTSPI_MOSI_PORT, SOFTSPI_MOSI_PIN|SOFTSPI_CLK_PIN);
   ...
   // S_GPIO_Set_Bits(ENABLE_ADC_BATT_PORT, ENABLE_ADC_BATT_PIN);     //disable measuring
    
    S_GPIO_Clear_Bits(ENABLE_ADC_SUPERCAP_PORT, ENABLE_ADC_SUPERCAP_PIN);//enable measuring
   // S_GPIO_Set_Bits(ENABLE_ADC_SUPERCAP_PORT, ENABLE_ADC_SUPERCAP_PIN); //disable measuring
#endif
#ifdef ANSI_STACK
    /*************************************************************
  ****************************************************************
  ...
  ****************************************************************/
#ifdef MTR_SINGLE_PH
  /*Relay_1 status pin*/  
  S_GPIO_Clear_Bits(RLY_STATUS_PORT, RLY1_STATUS_PIN);    
  S_GpioInit_PIN(RLY_STATUS_PORT, RLY1_STATUS_PIN ,S_GPIO_Mode_INPUT ); 
#else//MTR_THREE_PH
  /*Relay_1 status pin*/  
  S_GPIO_Clear_Bits(RLY_STATUS_PORT, RLY1_STATUS_PIN);
  S_GpioInit_PIN(RLY_STATUS_PORT, RLY1_STATUS_PIN ,S_GPIO_Mode_INPUT );
  ...
  /*Relay_2 status pin*/  
  S_GPIO_Clear_Bits(RLY_STATUS_PORT, RLY2_STATUS_PIN);
  S_GpioInit_PIN(RLY_STATUS_PORT, RLY2_STATUS_PIN ,S_GPIO_Mode_INPUT );
  
  /*Relay_3 status pin*/  
  S_GPIO_Clear_Bits(RLY_STATUS_PORT, RLY3_STATUS_PIN);
  S_GpioInit_PIN(RLY_STATUS_PORT, RLY3_STATUS_PIN ,S_GPIO_Mode_INPUT ); 
#endif//MTR_SINGLE_PH 
#endif//ANSI_STACK     
}
/////////////////////////////-_E_-///////////////////////////////////////
...
**************************************************************
*************************************************************/
void S_GpioShutdownPWD(uint8_t enable_lcd)
{
...
#ifndef CTRL_GPRS_MODULE_CVR_SW
  S_GpioInit_PIN(SW_PORT,M_SW_PIN, S_GPIO_Mode_FORBIDDEN);
  S_GPIO_Set_Bits(SW_PORT,M_SW_PIN);
#endif
 ...
 //   S_GpioInit_PIN(EEPROM_WP_PORT, EEPROM_WP_PIN , S_GPIO_Mode_OUTPUT_CMOS); 
    ...
    S_GpioInit_PIN(SOFTSPI_WP_PORT, SOFTSPI_WP_PIN , GPIO_Mode_FORBIDDEN); 
    //S_GPIO_Clear_Bits(SOFTSPI_WP_PORT,SOFTSPI_WP_PIN);  

    S_GpioInit_PIN(SOFTSPI_MOSI_PORT, SOFTSPI_MOSI_PIN , GPIO_Mode_FORBIDDEN); 
    //S_GPIO_Clear_Bits(SOFTSPI_MOSI_PORT,SOFTSPI_MOSI_PIN);  

    S_GpioInit_PIN(SOFTSPI_MISO_PORT, SOFTSPI_MISO_PIN , GPIO_Mode_FORBIDDEN); 
    //S_GPIO_Clear_Bits(SOFTSPI_MISO_PORT,SOFTSPI_MISO_PIN);  

    S_GpioInit_PIN(SOFTSPI_CLK_PORT, SOFTSPI_CLK_PIN , GPIO_Mode_FORBIDDEN); 
    //S_GPIO_Clear_Bits(SOFTSPI_CLK_PORT,SOFTSPI_CLK_PIN); 

    S_GpioInit_PIN(SOFTSPI_CS_PORT, SOFTSPI_CS_PIN , GPIO_Mode_FORBIDDEN); 
    //S_GPIO_Clear_Bits(SOFTSPI_CS_PORT,SOFTSPI_CS_PIN);  
#endif
    ...
    S_GpioInit_PIN(CNTCT_CRD_DTCT_PORT, CRD_DTCT_PIN , S_GPIO_Mode_OUTPUT_CMOS);
    S_GPIO_Clear_Bits(CNTCT_CRD_DTCT_PORT,CRD_DTCT_PIN);  
    #endif
    S_GpioInit_PIN(MCU_RX_OP_TXD_PORT, MCU_RX_OP_TXD_PIN , S_GPIO_Mode_OUTPUT_CMOS); 
...
void S_GpioShutdownPWD(uint8_t enable_lcd)
{
 ...
 // S_GPIO_Clear_Bits(MCU_RX_OP_RXD_PORT,MCU_RX_OP_RXD_PIN);
   ...
   // S_GpioInit_PIN(SW_PORT, SW_SCROLL_UP_PIN |SW_SCROLL_DOWN_PIN |MD_SW_PIN |MAG_SW_PIN |TELT_SW_PIN |TERMINAL_SW_PIN,S_GPIO_Mode_FORBIDDEN);
    ...
    S_GpioInit_PIN(S_PORT_B , S_GPIO_Pin_1 , S_GPIO_Mode_FORBIDDEN);
   ...
   //Contact card 
    ...
    // UART 2 
    S_GpioInit_PIN(UART_RX2_PORT , UART_RX2_PIN , S_GPIO_Mode_FORBIDDEN);   
...
#ifdef EM_DL130_BOARD
    S_GpioInit_PIN(TMPR_LED_PORT, TMPR_LED_PIN | STATUS_LED_PIN ,S_GPIO_Mode_FORBIDDEN); //dual led
#else
...
#ifdef EM_DL130_BOARD
    //external metering V9340
    //S_GpioInit_PIN(RS485_UART_TX_PORT, RS485_UART_TX_PIN, S_GPIO_Mode_FORBIDDEN);
    S_GpioInit_PIN(UART_V9340_PORT_TX,UART_V9340_TX_PIN, S_GPIO_Mode_OUTPUT_CMOS);
    S_GPIO_Clear_Bits(UART_V9340_PORT_TX,UART_V9340_TX_PIN);


    S_GpioInit_PIN(S_PORT_E,S_GPIO_Pin_10,S_GPIO_Mode_FORBIDDEN);
    S_GpioInit_PIN(S_PORT_GPIO_RF,S_PIN_GPIO_0_RF,S_GPIO_Mode_FORBIDDEN);
    S_GpioInit_PIN(BUZZER_PORT, BUZZER_PIN , S_GPIO_Mode_FORBIDDEN);

    S_GpioInit_PIN(RS485_ENABLE_Pwr_PORT, RS485_ENABLE_Pwr_PIN , S_GPIO_Mode_OUTPUT_CMOS);
    S_GPIO_Clear_Bits(RS485_ENABLE_Pwr_PORT, RS485_ENABLE_Pwr_PIN);
...
void S_GpioWakeUpPinsInit (void)
{
  ...
  *************************************************************/ 
  ...
  #ifdef CTRL_GPRS_MODULE_CVR_SW
  PMU_WakeUpPinConfig(M_SW_PIN , IOA_FALLING); 
  #endif
  ...
  PMU_ClearIOAINTStatus(SW_SCROLL_UP_PIN | SW_SCROLL_DOWN_PIN);
    ...
    PMU_ClearIOAINTStatus(TELT_SW_PIN|TERMINAL_SW_PIN| M_SW_PIN );
