...
#define   MISS_NEUTRAL_PORT       GPIOA //will replaced by GPIO in this micro  
#define   MISS_NEUTRAL_PIN     GPIO_Pin_9 //will replaced by GPIO in this micro 
#endif
/*************************************************************
**************************************************************
**                   BUZZER section                         **
...
#else
#define TMPR_LED_PORT                      S_PORT_A
#define TMPR_LED_PIN          	        S_GPIO_Pin_1 //red_led in dual
#define STATUS_LED_PIN          	        S_GPIO_Pin_0 //green_led in dual

#define CRDT_LED_PORT                      S_PORT_C                    
#define CRDT_LED_PIN                       S_GPIO_Pin_12
#endif
...
#define ENABLE_ADC_BATT_PORT                 S_PORT_C
#define ENABLE_ADC_BATT_PIN                  S_GPIO_Pin_15
#define ENABLE_ADC_SUPERCAP_PORT             S_PORT_C
#define ENABLE_ADC_SUPERCAP_PIN              S_GPIO_Pin_14
#endif
...
#define SW_SCROLL_UP_PIN              S_GPIO_Pin_6 //S_GPIO_Pin_3
#define SW_SCROLL_DOWN_PIN            S_GPIO_Pin_4
#define MD_SW_PIN                     S_GPIO_Pin_3 ///S_GPIO_Pin_6
#define MAG_SW_PIN                    S_GPIO_Pin_8
#define M_SW_PIN                      S_GPIO_Pin_2
#else
#define SW_PORT                       S_PORT_A
...
#define RFID_MODULE_ENABLE_PORT_WITH_KEYPAD       S_PORT_A//IRQ_FCS_PORT
#define RFID_MODULE_ENABLE_PIN_WITH_KEYPAD        S_GPIO_Pin_5
#else
...
#else
#if defined (EM130_BOARD) && !defined (KEYPAD_FEATURE)  //TODO remove keypad feature
...
#define RLY_STATUS_PORT         S_PORT_A
#ifdef MTR_SINGLE_PH
#define RLY1_STATUS_PIN         S_GPIO_Pin_11
#else
#define RLY1_STATUS_PIN         S_GPIO_Pin_11
#define RLY2_STATUS_PIN         S_GPIO_Pin_4
#define RLY3_STATUS_PIN         S_GPIO_Pin_6
#endif
#endif//ANSI_STACK
