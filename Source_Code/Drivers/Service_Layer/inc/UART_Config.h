...
#define OPTICAL_UART_RECEIVE_ANSI()                                             S_UART_ReceiveData(OPTICAL_UART_PORT_NUMBER)
#define BLUTOOTH_UART_SEND_ANSI(DATA)                                           S_UART_SendData(CONNECTED_METER_MODEM,DATA)
#define BLUTOOTH_UART_RECEIVE_ANSI()                                            S_UART_ReceiveData(CONNECTED_METER_MODEM)
