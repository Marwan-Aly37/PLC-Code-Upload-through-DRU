...
/* #include "Dlms_Hdlc.h" */ /* module removed from the DRU build */
#include "v85xx_wdt.h"
#include "v85xx_isr.h"
#include "v85xx_tmr.h"
...
/* #include "ymodem.h" */ /* module removed from the DRU build */
...
void HardFault_Handler(void)
{
  ...
  uart_debug_byte ('h',10);
    ...
    /* CTRL_SW_STATE_STORE(&ctrl_power_down_event); */  /* file system not built for the DRU */
...
void PMU_IRQHandler(void)
{
  ...
  {   
    ...
    /* V9203_IRQ_isr(); */  /* metering not built for the DRU */
  ...
  {   
    ...
    /* task_priority_set(PRIORITY_FOR_METER_TASK); */  /* metering task / task_priority not built for the DRU */
  }
#endif
#ifdef CTRL_GPRS_MODULE_CVR_SW
...
#endif 
      /* seconds_wasSaved++; */  /* metering not built for the DRU */
      /* seconds_wasSaved_2++; */  /* metering not built for the DRU */
      /* Tooling_Counter++ dropped: self-test/tooling module is not built. */
    }
        else
    {
#ifndef TRF_GRACE_48_HOURS_COMPARING_TIME
...
void TMR1_IRQHandler(void)
{
  if (TMR_GetINTStatus(TMR1))
  {
    ...
    /* PHDOWN_chk_event = SET; */  /* metering not built for the DRU */
    counter_tmr1 ++;
    count1_tmr1++;
  }
  #ifdef DEBUG_HANG_LOOPING
