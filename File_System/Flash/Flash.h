...
typedef enum {
  ...
  FLASH_PROTECTION_ENABLED =(uint8_t)21,
}Flash_errors_Enmt;
//-------------------------------------------------------------

// Bit masks from Status Register-1
#define SR_BP0   (1 << 2)
#define SR_BP1   (1 << 3)
#define SR_BP2   (1 << 4)
#define SR_SEC   (1 << 6)
...
typedef enum{
  dotmatrixcrc       = PAGESIZE*289,   /** last 128 kbytes**/
  dotmatrixdata      = PAGESIZE*290,   /** last 128 kbytes**/
  dotmatrixpage      = PAGESIZE*291,   /** last 128 kbytes**/
  plcfirmwaredata    = PLC_FIRMWARE_START_ADDRESS,  /*  7A00 starting address of PLC firmware - Moustafa */
  rfformwaredate     = RF_FIRMWARE_START_ADDRESS,

}InternalFlashPages_t;
